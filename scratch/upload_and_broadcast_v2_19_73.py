...
APK_PATH = r"c:\Users\danus\Documents\antigravity\emergent\app\build\outputs\apk\release\posbah-v2.19.73.apk"
APK_FILENAME = "posbah-v2.19.73.apk"
VERSION = "2.19.73"
VERSION_CODE = 180
...
# Ambil deskripsi versi 2.19.73 saja
current_version_desc = full_notes
if "\n---\n" in full_notes:
    current_version_desc = full_notes.split("\n---\n")[0].strip()
...
email_subject = "Pembaruan POSBah v2.19.73 - Fitur Manajemen Sopir Armada & Pengiriman Barang"
blast_payload = {
    "subject": email_subject,
    "message": current_version_desc
}
blast_res = requests.post(f"{BASE_URL}/api/admin/blast-update-email", headers=headers, json=blast_payload, timeout=60)
