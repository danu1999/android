...
APK_PATH = r"c:\Users\danus\Documents\antigravity\emergent\app\build\outputs\apk\release\posbah-v2.19.75.apk"
APK_FILENAME = "posbah-v2.19.75.apk"
VERSION = "2.19.75"
VERSION_CODE = 182
...
release_notes_plain = """Pembaruan v2.19.75:
1. Lampiran CV (PDF): Formulir calon karyawan kini mendukung upload file CV/Resume berformat PDF (maksimal 500 KB).
2. Pilihan Upload Fleksibel: Pengambilan foto KTP, Pas Foto, dan SIM kini bisa langsung dari Kamera, Galeri Foto, maupun File Manager HP dengan kompresi otomatis di bawah 500 KB.
3. Tombol Lihat CV di Aplikasi: Owner/HR dapat langsung melihat/membuka dokumen CV PDF pelamar dari tab Calon Karyawan.
4. Peningkatan Kecepatan & Stabilitas Formulir Pendaftaran."""
