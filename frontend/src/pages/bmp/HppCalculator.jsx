...
const HppCalculator = () => {
    ...
    try {
      ...
      if (Object.keys(params).length === 0 && responseData) {
        setSim({
          ...
          harga_bahan: responseData.default_harga_bahan || 8e3,
          isi_karung: 50
        });
      }
    } catch (err) {
  ...
  if (loading && !data) return <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "80vh", flexDirection: "column", gap: "15px" }}>
  ...
  return <div style={{ padding: isMobile ? "15px" : "30px", background: "#f8f9fa", minHeight: "100%", maxWidth: "100vw", boxSizing: "border-box", overflowX: "hidden" }}>
    ...
    /* Sidebar Simulator */
        ...
        <div style={{ flex: "1", minWidth: isMobile ? "100%" : "320px", maxWidth: isMobile ? "100%" : "350px" }}>
          ...
          {data && <div style={{ background: "#1e293b", color: "white", padding: "20px", borderRadius: "24px", marginTop: "20px", boxShadow: "0 4px 15px rgba(0,0,0,0.1)" }}>
    ...
    /* Main Results */
        ...
        <div style={{ flex: "1", display: "flex", flexDirection: "column", gap: "15px" }}>
          {isMobile ? (
    /* Mobile Cards */
    data?.hpp_results?.map((r, idx) => <div key={idx} style={{ background: "white", borderRadius: "20px", padding: "20px", boxShadow: "0 4px 6px rgba(0,0,0,0.02)", border: "1px solid #f1f5f9" }}>
                    ...
                    <div style={{ display: "flex", gap: "8px", marginBottom: "15px", flexWrap: "wrap" }}>
                        ...
                        {r.product.RejectRate > 0 && <span style={{ background: "#fee2e2", color: "#991b1b", padding: "2px 8px", borderRadius: "6px", fontSize: "11px" }}>
    ...
    <div style={{ background: "white", borderRadius: "24px", padding: "15px", boxShadow: "0 4px 12px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9" }}>
                <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0 8px", textAlign: "left" }}>
                  ...
                  <tbody>
                    {data?.hpp_results?.map((r, idx) => <tr key={idx} style={{ background: "#ffffff" }}>
          ...
          {(!data?.hpp_results || data.hpp_results.length === 0) && !loading && <div style={{ textAlign: "center", padding: "50px", background: "white", borderRadius: "24px", color: "#64748b" }}>
