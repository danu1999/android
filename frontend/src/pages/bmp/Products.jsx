...
const Products = () => {
  ...
  />
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "15px" }}>
          {filteredProducts.map((p) => <div key={p.ID} style={{ background: "white", borderRadius: "16px", padding: "18px", boxShadow: "0 4px 6px rgba(0,0,0,0.05)", border: "1px solid #f1f5f9" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", background: "#f8fafc", padding: "12px", borderRadius: "10px", marginBottom: "15px" }}>
                ...
                {(p.RejectRate ?? 0) > 0 && <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "12px", color: "#dc2626", fontWeight: "600" }}>
                    Reject: {p.RejectRate}%
                  </div>}
              </div>
    ...
    <div style={{ background: "white", borderRadius: "16px", padding: "10px", boxShadow: "0 4px 6px rgba(0,0,0,0.05)", border: "1px solid #f1f5f9", overflow: "hidden" }}>
          <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0 10px", textAlign: "left" }}>
            ...
            <tbody>
              {filteredProducts.map((p) => <tr key={p.ID} style={{ background: "#ffffff", transition: "background 0.2s" }}>
                  ...
                  <td style={{ padding: "15px 20px", borderBottom: "1px solid #f1f5f9" }}>
                    {(p.RejectRate ?? 0) > 0 ? <span style={{ background: "#fee2e2", color: "#b91c1c", padding: "2px 8px", borderRadius: "6px", fontSize: "12px", fontWeight: "700" }}>{p.RejectRate}%</span> : <span style={{ color: "#94a3b8", fontSize: "12px" }}>-</span>}
                  </td>
      ...
      {filteredProducts.length === 0 && !loading && <div style={{ textAlign: "center", padding: "40px", color: "#64748b" }}>
    ...
    /* MODAL FORM */
      ...
      {showModal && <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.7)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 1200, padding: "15px", backdropFilter: "blur(4px)" }}>
            ...
            <form onSubmit={handleSave}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px", marginBottom: "18px" }}>
                ...
                <div>
                    ...
                    <input type="number" required value={formData.Price} onChange={(e) => setFormData({ ...formData, Price: e.target.value })} style={{ width: "100%", padding: "12px", border: "1px solid #e2e8f0", borderRadius: "10px", boxSizing: "border-box", outline: "none" }} />
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px", marginBottom: "18px" }}>
                <div>
                    ...
                    <input type="number" step="0.01" value={formData.BeratGram} onChange={(e) => setFormData({ ...formData, BeratGram: e.target.value })} style={{ width: "100%", padding: "12px", border: "1px solid #e2e8f0", borderRadius: "10px", boxSizing: "border-box", outline: "none" }} />
                </div>
                <div>
                    <label style={{ display: "block", marginBottom: "8px", fontSize: "13px", fontWeight: "600", color: "#64748b" }}>Cycle Time (s)</label>
                    <input type="number" step="0.01" value={formData.CycleTime} onChange={(e) => setFormData({ ...formData, CycleTime: e.target.value })} style={{ width: "100%", padding: "12px", border: "1px solid #e2e8f0", borderRadius: "10px", boxSizing: "border-box", outline: "none" }} />
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px", marginBottom: "18px", background: "#f0f9ff", padding: "15px", borderRadius: "12px", border: "1px solid #bae6fd" }}>
                <div>
                    ...
                    <input type="number" min="1" value={formData.Cavity || 1} onChange={(e) => setFormData({ ...formData, Cavity: e.target.value })} style={{ width: "100%", padding: "12px", border: "1px solid #bae6fd", borderRadius: "10px", boxSizing: "border-box", outline: "none", background: "white" }} />
                </div>
                <div>
                    <label style={{ display: "block", marginBottom: "8px", fontSize: "13px", fontWeight: "600", color: "#0369a1" }}>Reject Rate (%)</label>
                    <input type="number" min="0" max="100" step="0.1" value={formData.RejectRate || 0} onChange={(e) => setFormData({ ...formData, RejectRate: e.target.value })} style={{ width: "100%", padding: "12px", border: "1px solid #bae6fd", borderRadius: "10px", boxSizing: "border-box", outline: "none", background: "white" }} />
                </div>
