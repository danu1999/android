...
const Pricelist = () => {
  ...
  if (loading && data.length === 0) return <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "80vh", flexDirection: "column", gap: "15px" }}>
  ...
  >
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
          {data && data.map((d, idx) => <div key={idx} style={{ background: "white", borderRadius: "20px", padding: "20px", boxShadow: "0 4px 6px rgba(0,0,0,0.02)", border: "1px solid #f1f5f9" }}>
    ...
    <div style={{ background: "white", borderRadius: "24px", padding: "15px", boxShadow: "0 4px 12px rgba(0,0,0,0.03)", border: "1px solid #f1f5f9" }}>
          <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: "0 8px", textAlign: "left" }}>
            ...
            <tbody>
              {data && data.map((d, idx) => <tr key={idx} style={{ background: "#ffffff" }}>
      ...
      {(!data || data.length === 0) && !loading && <div style={{ textAlign: "center", padding: "50px", background: "white", borderRadius: "24px", color: "#64748b" }}>
