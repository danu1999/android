...
const Clients = () => {
  ...
  const filteredClients = clients.filter(
    (c) => (c.ClientName || "").toLowerCase().includes(searchTerm.toLowerCase()) || (c.Province || "").toLowerCase().includes(searchTerm.toLowerCase()) || (c.PhoneNumber || "").toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  >
    ...
    return <div key={c.ID} className="client-card" style={{ background: "#ffffff", borderRadius: "16px", border: "1px solid #e2e8f0", padding: "18px", display: "flex", flexDirection: "column", boxShadow: "0 4px 6px rgba(0,0,0,0.01)" }}>
      ...
      /* Card Details */
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "8px", flex: 1 }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: "13px" }}>
                      ...
                      {c.PhoneNumber ? <a href={`tel:${c.PhoneNumber}`} style={{ color: "#0d6efd", fontWeight: "600", textDecoration: "none", display: "flex", alignItems: "center", gap: "3px" }}>
                          {c.PhoneNumber} <ArrowUpRight size={12} />
                        </a> : <span style={{ color: "#94a3b8", fontStyle: "italic" }}>-</span>}
                    </div>
    ...
    /* Empty state */
          ...
          {filteredClients.length === 0 && <div style={{ textAlign: "center", padding: "60px 20px", background: "#ffffff", borderRadius: "16px", border: "1px solid #e2e8f0", marginTop: "10px" }}>
    ...
    /* Modern Modal with Backdrop Blur */
      ...
      {showModal && <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(15, 23, 42, 0.45)", backdropFilter: "blur(4px)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 1e3, padding: "15px" }}>
          <div style={{ background: "white", padding: "25px", borderRadius: "20px", width: "100%", maxWidth: "420px", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1), 0 10px 10px -5px rgba(0,0,0,0.04)", boxSizing: "border-box" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
              <h3 style={{ fontSize: "18px", fontWeight: "800", color: "#1e293b", margin: 0 }}>
                {formData.id > 0 ? "\u{1F4DD} Edit Data Klien" : "\u{1F464} Tambah Klien Baru"}
              </h3>
