                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '20px' }}>
                            {filteredHistory.length > 0 ? filteredHistory.map((item: any, idx: number) => {
                                ...
                                return (
                                    <div key={item.ID || idx} className="history-card" style={{ background: '#ffffff', borderRadius: '16px', border: '1px solid #e2e8f0', padding: '18px', display: 'flex', flexDirection: 'column', boxShadow: '0 4px 6px rgba(0,0,0,0.01)' }}>
