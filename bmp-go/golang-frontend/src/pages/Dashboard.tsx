...
import { Zap, Users, Package, TrendingUp, DollarSign, Clock, CheckCircle, ArrowRight, ShieldAlert, BookOpen, PlusCircle } from 'lucide-react';
...
interface DashboardData {
  ...
  total_kas_in: number;
  total_kas_out: number;
  saldo_kas: number;
  nono_total_bahan: number;
  nono_total_bayar: number;
  nono_sisa_hutang: number;
  recent_invoices: any[];
  count_lunas: number;
  total_lunas_idr: number;
  count_belum: number;
  total_belum_idr: number;
  count_telat: number;
  total_telat_idr: number;
  total_invoices_idr: number;
  simulasi_saldo: number;
}
      ...
      <div className="stats-grid">
        ...
        <div className="card-premium" style={{ padding: '14px 16px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ borderLeft: '1px solid #cbd5e1', height: '30px', margin: '0 8px' }}></div>
            <div>
