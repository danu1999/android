...
interface FactorySettings {
  ...
  PhoneNumber: string;
  EmailAddress: string;
  ListrikBulanan: number;
  JumlahMesin: number;
  JumlahKaryawan: number;
  GajiHarian: number;
  HariKerjaSebulan: number;
  HoursPerDay: number;
  BiayaKarungPer1000: number;
  ClientLogo: string;
}
...
const Settings: React.FC = () => {
  ...
  return (
    <div style={{ padding: isMobile ? '15px' : '40px', background: '#f8f9fa', minHeight: '100%', maxWidth: '100vw', boxSizing: 'border-box' }}>
