    ...
    suspend fun upsertPrintSettings(
        ...
        val array = JSONArray().apply {
            put(JSONObject().apply {
                ...
                put("logoUrl", settings.logoUrl ?: JSONObject.NULL)
                put("jpgSignatureDrawnUrl", settings.jpgSignatureDrawnUrl ?: JSONObject.NULL)
                put("sjSignatureDrawnUrl", settings.sjSignatureDrawnUrl ?: JSONObject.NULL)
                put("invoiceSignatureDrawnUrl", settings.invoiceSignatureDrawnUrl ?: JSONObject.NULL)
